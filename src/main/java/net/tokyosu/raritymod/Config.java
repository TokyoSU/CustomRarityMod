...
public class Config
{
    ...
    {
        RARITY_COMMON_LIST = ITEM_RARITY_COMMON.get().stream().map(ResourceLocation::parse).collect(Collectors.toSet());
        RARITY_UNCOMMON_LIST = ITEM_RARITY_UNCOMMON.get().stream().map(ResourceLocation::parse).collect(Collectors.toSet());
        RARITY_RARE_LIST = ITEM_RARITY_RARE.get().stream().map(ResourceLocation::parse).collect(Collectors.toSet());
        RARITY_EPIC_LIST = ITEM_RARITY_EPIC.get().stream().map(ResourceLocation::parse).collect(Collectors.toSet());
        RARITY_LEGENDARY_LIST = ITEM_RARITY_LEGENDARY.get().stream().map(ResourceLocation::parse).collect(Collectors.toSet());
        RARITY_UNIQUE_LIST = ITEM_RARITY_UNIQUE.get().stream().map(ResourceLocation::parse).collect(Collectors.toSet());
        RARITY_MYTHIC_LIST = ITEM_RARITY_MYTHIC.get().stream().map(ResourceLocation::parse).collect(Collectors.toSet());
        RARITY_GOD_LIST = ITEM_RARITY_GOD.get().stream().map(ResourceLocation::parse).collect(Collectors.toSet());
    }
}
