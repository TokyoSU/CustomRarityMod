...
public class Constants {
    ...
    public static final Rarity RARITY_EPIC = Rarity.create("raritymod.epic", ChatFormatting.DARK_PURPLE);
    public static final Rarity RARITY_LEGENDARY = Rarity.create("raritymod.legendary", ChatFormatting.YELLOW);
    public static final Rarity RARITY_UNIQUE = Rarity.create("raritymod.unique", ChatFormatting.GOLD);
